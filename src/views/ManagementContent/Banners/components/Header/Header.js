...
const Header = props => {
  ...
  const renderSearch = () => (
    ...
    >
      ...
      <MenuItem value={'hoempage'}>Homepage</MenuItem>
      <MenuItem value={'bincangbisnis'}>Bincang Bisnis</MenuItem>
      <MenuItem value={'sentrabelajar'}>Sentra Belajar</MenuItem>
      <MenuItem value={'pasarumkm'}>Pasar UMKM</MenuItem>
    </Select>
  );
          ...
          >
            ...
            >
              ...
              <Typography
                style={{marginTop:'5px'}}
                variant="h6"
              >Atur konten banner untuk aplikasi mobile DiSentra</Typography>
            </Grid>
            <Hidden mdDown>
              <Grid
                item
