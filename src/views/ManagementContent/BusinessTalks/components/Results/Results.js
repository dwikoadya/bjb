...
import { setBusinessTalkDataDetail } from 'actions';
...
const Results = props => {
  ...
  const showDataDetailModal = (index, noEdit) => {
    ...
    dispatch(setBusinessTalkDataDetail({
      payload: data[index]
    }))
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>Jml. Peserta(Max.)</TableCell>
                ...
                <TableBody>
                  {data.map((content, index) => (
                    ...
                    >
                      ...
                      <TableCell>{content.talk_type === 'grupchat' ? 'Group Chat' : 'Sentraminar'}</TableCell>
                      <TableCell>
                        {content.event_on_display}
                      </TableCell>
                      <TableCell>
                        {content.max_participant}
                        <Link 
                          color="secondary"
                          href="#" 
                          underline="always"
